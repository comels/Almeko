...
const ListRecipes = ({ recipe }) => {
  return (
    <Link href={`/recette/${recipe.id}`}>
      <div className="flex min-h-40 max-w-xl flex-col justify-center rounded-lg border-8 border-myblue bg-white">
        <h1 className="mx-5 mb-4 text-center text-2xl font-extrabold tracking-tight sm:text-3xl">
          {recipe.name}
        </h1>
